...
<div class="container">
    ...
    <h6><center><i>Plain Consonants</i></center></h6>
    ...
    <div class="row justify-content-center">
        ...
        // Query the database 
        $sql = "SELECT * FROM korean_lesson WHERE category = 'plain_consonant'";
    ...
    <div class="row justify-content-end">
        <div class="col-12 text-right">
            <a href="korean_lesson1_doubleVowel.php" class="btn btn-primary back-btn">Back</a>
            <a href="korean.php" class="btn btn-primary">Finish</a>
        </div>
    </div>
