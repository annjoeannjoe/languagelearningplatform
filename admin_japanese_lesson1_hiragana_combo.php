...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        $sql = "SELECT * FROM japanese_lesson WHERE category = 'Combo'";
    ...
    <div class="row justify-content-center">
        <div class="col-12 text-right">
            <a href="admin_japanese_lesson1_hiragana_dakuon.php" class="btn btn-primary back-btn">Back</a>
