...
<body>
  ...
  <?php
    ...
    $lessons = array(
      array('id' => 1, 'lesson_title' => 'Lesson 1: Hiragana and Katakana', 'details_file' => 'admin_japanese_lesson1.php', 'edit_file' => 'add_japanese_word.php'),
      array('id' => 2, 'lesson_title' => 'Lesson 2: Japanese Greetings', 'details_file' => 'admin_japanese_lesson2.php', 'edit_file' => 'add_japanese_lesson2.php')
    );
