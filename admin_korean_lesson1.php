...
<div class="container">
    ...
    <h6><center><i>Get to know the main writing system in Korea</i></center></h6>
    ...
    <div class="row justify-content-center">
        ...
        // Query the database 
        $sql = "SELECT * FROM korean_lesson WHERE category = 'main_writing'";
    ...
    <div class="row justify-content-end">
        <div class="col-12 text-right">
            <a href="admin_korean_lesson1_doubleVowel.php" class="btn btn-primary">Next</a>
        </div>
    </div>
