...
<?php include 'nav.php'; ?>
<head>
  <title>Japanese Language Learning</title>
        ...
        <div class="container-with-sidebar">
          <div class="sidebar">
            <ul>
              ...
              <li><a href="#"><i class="fas fa-file-alt"></i> Exercises</a></li>
              <li><a href="#"><i class="fas fa-volume-up"></i> Practice</a></li>
              <li><a href="#"  onclick="goToQuestionPage('Chinese')" ><i class="fas fa-question-circle"></i> Quizzes</a></li>
            </ul>
          </div>
          <div class="content">
            <div class="language-section" id="lesson-materials">
              ...
              <div class="section-content">
                ...
                <ul>
                  <li><a href="chinese_lesson1.php">Lesson 1: Pronunciations Basics</a></li>
                  <li><a href="chinese_lesson2.php">Lesson 2: Hello in Chinese</a></li>
                  <li><a href="#">Lesson 3: Please and Thank You</a></li>
                  <li><a href="#">Lesson 4: Good Bye</a></li>
                </ul>
              </div>
            </div>
